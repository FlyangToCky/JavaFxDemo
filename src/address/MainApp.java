...
//	它将会在应用程序运行时通过内部的 main 方法自动调用
	@Override
	public void start(Stage primaryStage) {
		/*
		 * 这里的 Stage 是一个主容器，它就是我们通常所认为的窗口（有边，高和宽，还有关闭按钮）。
		 * 在这个 Stage 里面，你可以放置一个 Scene，当然你可以切换别的 Scene，而在这个 Scene 里面，
		 * 我们就可以放置各种各样的控件。
		 */
		this.primaryStage = primaryStage;
        this.primaryStage.setTitle("测试应用");
    ...
    public void initRootLayout() {
        ...
        // Try to load last opened person file.加载最新打开的人员文件
